# WebsiteAnalysisApis2 Python SDK



The Python SDK for the WebsiteAnalysisApis2 API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.DeadLinkChecker()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/website-analysis-apis2-sdk/releases)) or
...
```
py/
├── websiteanalysisapis2_sdk.py         -- Main SDK module
...
The main module (`websiteanalysisapis2_sdk`) exports the SDK class.
