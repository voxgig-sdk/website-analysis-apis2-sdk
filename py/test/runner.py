# WebsiteAnalysisApis2 SDK test runner
...
class WebsiteAnalysisApis2TestRunner:
    _env = {}
    ...
    def load_env_local():
        ...
        for line in content.splitlines():
            ...
            WebsiteAnalysisApis2TestRunner._env[key] = val

    @staticmethod
    def getenv(key):
        val = WebsiteAnalysisApis2TestRunner._env.get(key)
        if val is not None:
            return val
    ...
    @staticmethod
    def env_override(m):
        live = WebsiteAnalysisApis2TestRunner.getenv("WEBSITE_ANALYSIS_APIS2_TEST_LIVE")
        override = WebsiteAnalysisApis2TestRunner.getenv("WEBSITE_ANALYSIS_APIS2_TEST_OVERRIDE")

        if live == "TRUE" or override == "TRUE":
            for key in list(m.keys()):
                envval = WebsiteAnalysisApis2TestRunner.getenv(key)
        ...
        explain = WebsiteAnalysisApis2TestRunner.getenv("WEBSITE_ANALYSIS_APIS2_TEST_EXPLAIN")
    ...
    def load_test_control():
        ...
        """
        if WebsiteAnalysisApis2TestRunner._test_control is not None:
            return WebsiteAnalysisApis2TestRunner._test_control
        ctrl_path = os.path.join(os.path.dirname(__file__), "sdk-test-control.json")
        try:
            with open(ctrl_path, "r") as f:
                WebsiteAnalysisApis2TestRunner._test_control = json.load(f)
        except (FileNotFoundError, IOError, ValueError):
            WebsiteAnalysisApis2TestRunner._test_control = {
                "version": 1,
                "test": {"skip": {
    ...
    def is_control_skipped(kind, name, mode):
        ...
        ctrl = WebsiteAnalysisApis2TestRunner.load_test_control()
...
def load_env_local():
    WebsiteAnalysisApis2TestRunner.load_env_local()


def env_override(m):
    return WebsiteAnalysisApis2TestRunner.env_override(m)


def entity_data(v):
    return WebsiteAnalysisApis2TestRunner.entity_data(v)


def entity_list_to_data(lst):
    return WebsiteAnalysisApis2TestRunner.entity_list_to_data(lst)


def is_control_skipped(kind, name, mode):
    return WebsiteAnalysisApis2TestRunner.is_control_skipped(kind, name, mode)


def load_test_control():
    return WebsiteAnalysisApis2TestRunner.load_test_control()


def live_delay_ms():
    return WebsiteAnalysisApis2TestRunner.live_delay_ms()
