# WebsiteAnalysisApis2 SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions WebsiteAnalysisApis2SDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both WebsiteAnalysisApis2SDK(...) and WebsiteAnalysisApis2SDK.test(...) become
#      WebsiteAnalysisApis2SDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "websiteanalysisapis2_sdk"
_SDK_CLASS = "WebsiteAnalysisApis2SDK"
...
_ENTITIES = {
    "DeadLinkChecker": "dead_link_checker",
    "Performance": "performance",
    "Screenshot": "screenshot",
    "Seo": "seo",
    "Ssl": "ssl",
    "TechStackDetection": "tech_stack_detection",
}
