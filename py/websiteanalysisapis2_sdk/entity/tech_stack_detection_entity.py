...
from websiteanalysisapis2_sdk.websiteanalysisapis2_types import (
    TechStackDetection,
...
class TechStackDetectionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return TechStackDetectionEntity(self._client, opts)
    ...
    def data_get(self) -> TechStackDetection:
    ...
    def match_get(self) -> TechStackDetection:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[TechStackDetection]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.TechStackDetection().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
