...
class DeadLinkCheckerEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return DeadLinkCheckerEntity(self._client, opts)
    ...
    def data_get(self) -> DeadLinkChecker:
    ...
    def match_get(self) -> DeadLinkChecker:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[DeadLinkChecker]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.DeadLinkChecker().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
