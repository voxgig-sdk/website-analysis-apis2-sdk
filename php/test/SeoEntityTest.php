...
class SeoEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set WEBSITEANALYSISAPIS__TEST_SEO_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function seo_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("WEBSITEANALYSISAPIS__TEST_SEO_ENTID");
