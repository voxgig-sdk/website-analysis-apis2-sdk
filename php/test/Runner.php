...
class WebsiteAnalysisApis2TestRunner
{
    ...
    {
        $live = self::getenv('WEBSITEANALYSISAPIS2_TEST_LIVE');
        $override = self::getenv('WEBSITEANALYSISAPIS2_TEST_OVERRIDE');
        ...
        $explain = self::getenv('WEBSITEANALYSISAPIS2_TEST_EXPLAIN');
