...
class SeoDirectTest extends TestCase
{
    public function test_direct_list_seo(): void
    {
        $setup = seo_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-seo", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
...
function seo_direct_setup($mockres)
{
