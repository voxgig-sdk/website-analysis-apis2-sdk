...
// WebsiteAnalysisApis2 SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (WebsiteAnalysisApis2SDK::test)
...
{
    private const SDK_CLASS = 'WebsiteAnalysisApis2SDK';
    ...
    private const SDK_BASE = 'websiteanalysisapis2_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../websiteanalysisapis2_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
