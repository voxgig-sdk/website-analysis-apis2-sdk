...
// WebsiteAnalysisApis2 SDK Seo entity
...
class SeoEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SeoEntity($this->_client, $opts);
    }

    /**
     * @param Seo|array $args Seo data (assoc-array) to store.
     */
    ...
    /**
     * @return Seo|array The current Seo data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Seo fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Seo fields).
     */
    ...
    /**
     * List Seo items matching the given filter.
     *
     * @param SeoListMatch|array|null $reqmatch Match filter (any subset
     *   of Seo fields) as an assoc-array; SeoListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Seo[]|array A list of Seo items as assoc-arrays at
