...
// WebsiteAnalysisApis2 SDK Ssl entity
...
class SslEntity
{
     ...
     * Load a single Ssl.
     *
     * @param SslLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed SslLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Ssl|array The loaded Ssl as an assoc-array at the
