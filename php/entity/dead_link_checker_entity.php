...
// WebsiteAnalysisApis2 SDK DeadLinkChecker entity
...
class DeadLinkCheckerEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DeadLinkCheckerEntity($this->_client, $opts);
    }

    /**
     * @param DeadLinkChecker|array $args DeadLinkChecker data (assoc-array) to store.
     */
    ...
    /**
     * @return DeadLinkChecker|array The current DeadLinkChecker data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DeadLinkChecker fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DeadLinkChecker fields).
     */
    ...
    /**
     * List DeadLinkChecker items matching the given filter.
     *
     * @param DeadLinkCheckerListMatch|array|null $reqmatch Match filter (any subset
     *   of DeadLinkChecker fields) as an assoc-array; DeadLinkCheckerListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DeadLinkChecker[]|array A list of DeadLinkChecker items as assoc-arrays at
