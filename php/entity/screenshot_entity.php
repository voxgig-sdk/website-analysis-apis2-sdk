...
// WebsiteAnalysisApis2 SDK Screenshot entity
...
class ScreenshotEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ScreenshotEntity($this->_client, $opts);
    }

    /**
     * @param Screenshot|array $args Screenshot data (assoc-array) to store.
     */
    ...
    /**
     * @return Screenshot|array The current Screenshot data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Screenshot fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Screenshot fields).
     */
    ...
    /**
     * Load a single Screenshot.
     *
     * @param ScreenshotLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ScreenshotLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Screenshot|array The loaded Screenshot as an assoc-array at the
