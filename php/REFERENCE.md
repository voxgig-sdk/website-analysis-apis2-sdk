# WebsiteAnalysisApis2 PHP SDK Reference

Complete API reference for the WebsiteAnalysisApis2 PHP SDK.
...
#### `WebsiteAnalysisApis2SDK::test($testopts = null, $sdkopts = null)`
...
#### `DeadLinkChecker($data = null)`

Create a new `DeadLinkCheckerEntity` instance. Pass `null` for no initial data.
...
#### `TechStackDetection($data = null)`

Create a new `TechStackDetectionEntity` instance. Pass `null` for no initial data.

#### `options_map(): array`

Return a deep copy of the current SDK options.

#### `get_utility(): WebsiteAnalysisApis2Utility`
