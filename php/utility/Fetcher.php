...
// WebsiteAnalysisApis2 SDK utility: fetcher

class WebsiteAnalysisApis2Fetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; WebsiteAnalysisApis2SDK/1.0)';
    ...
    public static function call(WebsiteAnalysisApis2Context $ctx, string $fullurl, array $fetchdef): array
    {
