...
// WebsiteAnalysisApis2 SDK telemetry feature
...
class WebsiteAnalysisApis2TelemetryFeature extends WebsiteAnalysisApis2BaseFeature
{
    ...
    private function _close(WebsiteAnalysisApis2Context $ctx, bool $ok): void
    {
