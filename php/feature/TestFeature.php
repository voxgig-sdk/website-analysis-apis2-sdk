...
// WebsiteAnalysisApis2 SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class WebsiteAnalysisApis2TestFeature extends WebsiteAnalysisApis2BaseFeature
{
    ...
    public function init(WebsiteAnalysisApis2Context $ctx, array $options): void
    {
        ...
        $test_fetcher = function (WebsiteAnalysisApis2Context $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = WebsiteAnalysisApis2Param::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (WebsiteAnalysisApis2Context $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(WebsiteAnalysisApis2Context $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = WebsiteAnalysisApis2Param::call($ctx, $k);
