...
// WebsiteAnalysisApis2 SDK streaming feature
...
class WebsiteAnalysisApis2StreamingFeature extends WebsiteAnalysisApis2BaseFeature
{
    ...
    private function _iterate(WebsiteAnalysisApis2Result $result): \Generator
    {
    ...
    private function _streamable(WebsiteAnalysisApis2Context $ctx): bool
    {
