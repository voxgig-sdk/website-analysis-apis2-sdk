...
// WebsiteAnalysisApis2 SDK ratelimit feature
...
class WebsiteAnalysisApis2RatelimitFeature extends WebsiteAnalysisApis2BaseFeature
{
    ...
    private function _acquire(WebsiteAnalysisApis2Context $ctx): void
    {
    ...
    private function _track(WebsiteAnalysisApis2Context $_ctx, float $wait_ms): void
    {
        $client = $this->client;
