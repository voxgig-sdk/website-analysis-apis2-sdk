...
// WebsiteAnalysisApis2 SDK audit feature
...
class WebsiteAnalysisApis2AuditFeature extends WebsiteAnalysisApis2BaseFeature
{
    ...
    private function _emit(WebsiteAnalysisApis2Context $ctx, string $outcome): void
    {
