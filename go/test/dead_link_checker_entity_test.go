...
func dead_link_checkerBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("WEBSITE_ANALYSIS_APIS2_TEST_DEAD_LINK_CHECKER_ENTID")
	...
	idmapResolved := core.ToMapAny(env["WEBSITE_ANALYSIS_APIS2_TEST_DEAD_LINK_CHECKER_ENTID"])
