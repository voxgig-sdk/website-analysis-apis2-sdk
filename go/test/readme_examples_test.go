...
const testSeed = `map[string]any{"entity": map[string]any{"dead_link_checker": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "performance": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "screenshot": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "seo": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ssl": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "tech_stack_detection": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
