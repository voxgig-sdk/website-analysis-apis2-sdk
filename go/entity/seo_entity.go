...
func NewSeoEntity(client *core.WebsiteAnalysisApis2SDK, entopts map[string]any) *SeoEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SeoEntity) GetName() string { return e.name }
...
func (e *SeoEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SeoEntity) Deleted() bool {
	return e.deleted
}


func (e *SeoEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSeoEntity(e.client, opts)
}

func (e *SeoEntity) Data(args ...any) any {
...
func (e *SeoEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Seo; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SeoEntity) DataTyped(data ...Seo) Seo {
	if len(data) > 0 {
		return typedFrom[Seo](e.Data(asMap(data[0])))
	}
	return typedFrom[Seo](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Seo (all fields
// optional at the wire level).
func (e *SeoEntity) MatchTyped(match ...Seo) Seo {
	if len(match) > 0 {
		return typedFrom[Seo](e.Match(asMap(match[0])))
	}
	return typedFrom[Seo](e.Match())
}
...
func (e *SeoEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SeoEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *SeoEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SeoListMatch and returns []Seo. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *SeoEntity) ListTyped(reqmatch SeoListMatch, ctrl map[string]any) ([]Seo, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Seo](res), nil
}



func (e *SeoEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SeoEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SeoEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SeoEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
