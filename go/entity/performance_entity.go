...
func NewPerformanceEntity(client *core.WebsiteAnalysisApis2SDK, entopts map[string]any) *PerformanceEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PerformanceEntity) GetName() string { return e.name }
...
func (e *PerformanceEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PerformanceEntity) Deleted() bool {
	return e.deleted
}


func (e *PerformanceEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPerformanceEntity(e.client, opts)
}

func (e *PerformanceEntity) Data(args ...any) any {
...
func (e *PerformanceEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Performance; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PerformanceEntity) DataTyped(data ...Performance) Performance {
	if len(data) > 0 {
		return typedFrom[Performance](e.Data(asMap(data[0])))
	}
	return typedFrom[Performance](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Performance (all fields
// optional at the wire level).
func (e *PerformanceEntity) MatchTyped(match ...Performance) Performance {
	if len(match) > 0 {
		return typedFrom[Performance](e.Match(asMap(match[0])))
	}
	return typedFrom[Performance](e.Match())
}
...
func (e *PerformanceEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PerformanceEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PerformanceLoadMatch and returns an Performance. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PerformanceEntity) LoadTyped(reqmatch PerformanceLoadMatch, ctrl map[string]any) (Performance, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Performance{}, err
	}
	return typedFrom[Performance](res), nil
}



func (e *PerformanceEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *PerformanceEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PerformanceEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PerformanceEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PerformanceEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
