...
type TechStackDetectionEntity struct {
	name    string
	client  *core.WebsiteAnalysisApis2SDK
...
func NewTechStackDetectionEntity(client *core.WebsiteAnalysisApis2SDK, entopts map[string]any) *TechStackDetectionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TechStackDetectionEntity) GetName() string { return e.name }
...
func (e *TechStackDetectionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TechStackDetectionEntity) Deleted() bool {
	return e.deleted
}


func (e *TechStackDetectionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTechStackDetectionEntity(e.client, opts)
}

func (e *TechStackDetectionEntity) Data(args ...any) any {
...
func (e *TechStackDetectionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an TechStackDetection; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TechStackDetectionEntity) DataTyped(data ...TechStackDetection) TechStackDetection {
	if len(data) > 0 {
		return typedFrom[TechStackDetection](e.Data(asMap(data[0])))
	}
	return typedFrom[TechStackDetection](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through TechStackDetection (all fields
// optional at the wire level).
func (e *TechStackDetectionEntity) MatchTyped(match ...TechStackDetection) TechStackDetection {
	if len(match) > 0 {
		return typedFrom[TechStackDetection](e.Match(asMap(match[0])))
	}
	return typedFrom[TechStackDetection](e.Match())
}
...
func (e *TechStackDetectionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TechStackDetectionEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *TechStackDetectionEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TechStackDetectionListMatch and returns []TechStackDetection. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *TechStackDetectionEntity) ListTyped(reqmatch TechStackDetectionListMatch, ctrl map[string]any) ([]TechStackDetection, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[TechStackDetection](res), nil
}



func (e *TechStackDetectionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TechStackDetectionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TechStackDetectionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TechStackDetectionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
