...
func NewScreenshotEntity(client *core.WebsiteAnalysisApis2SDK, entopts map[string]any) *ScreenshotEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ScreenshotEntity) GetName() string { return e.name }
...
func (e *ScreenshotEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ScreenshotEntity) Deleted() bool {
	return e.deleted
}


func (e *ScreenshotEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewScreenshotEntity(e.client, opts)
}

func (e *ScreenshotEntity) Data(args ...any) any {
...
func (e *ScreenshotEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Screenshot; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ScreenshotEntity) DataTyped(data ...Screenshot) Screenshot {
	if len(data) > 0 {
		return typedFrom[Screenshot](e.Data(asMap(data[0])))
	}
	return typedFrom[Screenshot](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Screenshot (all fields
// optional at the wire level).
func (e *ScreenshotEntity) MatchTyped(match ...Screenshot) Screenshot {
	if len(match) > 0 {
		return typedFrom[Screenshot](e.Match(asMap(match[0])))
	}
	return typedFrom[Screenshot](e.Match())
}
...
func (e *ScreenshotEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ScreenshotEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ScreenshotLoadMatch and returns an Screenshot. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ScreenshotEntity) LoadTyped(reqmatch ScreenshotLoadMatch, ctrl map[string]any) (Screenshot, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Screenshot{}, err
	}
	return typedFrom[Screenshot](res), nil
}



func (e *ScreenshotEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ScreenshotEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ScreenshotEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ScreenshotEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ScreenshotEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
