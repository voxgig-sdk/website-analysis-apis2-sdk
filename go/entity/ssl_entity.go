...
func NewSslEntity(client *core.WebsiteAnalysisApis2SDK, entopts map[string]any) *SslEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SslEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SslLoadMatch and returns an Ssl. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *SslEntity) LoadTyped(reqmatch SslLoadMatch, ctrl map[string]any) (Ssl, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Ssl{}, err
	}
	return typedFrom[Ssl](res), nil
}



func (e *SslEntity) List(_ map[string]any, _ map[string]any) (any, error) {
