...
func registerSDKWords(r *eng.Registry, client *sdk.WebsiteAnalysisApis2SDK) {
...
func runOp(client *sdk.WebsiteAnalysisApis2SDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
