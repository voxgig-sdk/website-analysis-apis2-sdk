...
// WebsiteAnalysisApis2 SDK utility type

class WebsiteAnalysisApis2Utility
{
    ...
    public static function copy(WebsiteAnalysisApis2Utility $src): WebsiteAnalysisApis2Utility
    {
        $u = new WebsiteAnalysisApis2Utility();
        $u->clean = $src->clean;
        $u->done = $src->done;
