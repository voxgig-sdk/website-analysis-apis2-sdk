...
// WebsiteAnalysisApis2 SDK utility: feature_init

class WebsiteAnalysisApis2FeatureInit
{
    public static function call(WebsiteAnalysisApis2Context $ctx, mixed $f): void
    {
        $fname = $f->get_name();
        $fopts = [];
        if ($ctx->options) {
