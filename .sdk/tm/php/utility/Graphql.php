...
// WebsiteAnalysisApis2 SDK utility: graphql
//
...
class WebsiteAnalysisApis2Graphql
{
    ...
    // equivalent.
    public static function body(WebsiteAnalysisApis2Context $ctx): mixed
    {
    ...
    public static function errors(WebsiteAnalysisApis2Context $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
