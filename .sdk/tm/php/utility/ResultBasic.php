...
// WebsiteAnalysisApis2 SDK utility: result_basic

class WebsiteAnalysisApis2ResultBasic
{
    public static function call(WebsiteAnalysisApis2Context $ctx): ?WebsiteAnalysisApis2Result
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof WebsiteAnalysisApis2Error) ? $result->err->msg : (string)$result->err;
