...
// WebsiteAnalysisApis2 SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class WebsiteAnalysisApis2MakeRequest
{
    public static function call(WebsiteAnalysisApis2Context $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new WebsiteAnalysisApis2Response(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new WebsiteAnalysisApis2Response($fetched);
        } else {
