...
// WebsiteAnalysisApis2 SDK proxy feature
...
class WebsiteAnalysisApis2ProxyFeature extends WebsiteAnalysisApis2BaseFeature
{
    ...
    public function init(WebsiteAnalysisApis2Context $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (WebsiteAnalysisApis2Context $ctx2, string $url2, array $fetchdef) use ($inner): array {
