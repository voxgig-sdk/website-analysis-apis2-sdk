...
// WebsiteAnalysisApis2 SDK clienttrack feature
...
class WebsiteAnalysisApis2ClienttrackFeature extends WebsiteAnalysisApis2BaseFeature
{
    ...
    public function PostConstruct(WebsiteAnalysisApis2Context $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'WebsiteAnalysisApis2-SDK';
