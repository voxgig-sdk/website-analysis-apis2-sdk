...
// WebsiteAnalysisApis2 SDK timeout feature
...
class WebsiteAnalysisApis2TimeoutFeature extends WebsiteAnalysisApis2BaseFeature
{
    ...
    private function _with_timeout(WebsiteAnalysisApis2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(WebsiteAnalysisApis2Context $_ctx, float $ms): void
    {
        $client = $this->client;
