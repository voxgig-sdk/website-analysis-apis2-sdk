...
// WebsiteAnalysisApis2 SDK cache feature
...
class WebsiteAnalysisApis2CacheFeature extends WebsiteAnalysisApis2BaseFeature
{
    ...
    private function _through(WebsiteAnalysisApis2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
