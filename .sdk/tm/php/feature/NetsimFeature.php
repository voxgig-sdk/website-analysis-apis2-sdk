...
// WebsiteAnalysisApis2 SDK netsim feature
...
class WebsiteAnalysisApis2NetsimFeature extends WebsiteAnalysisApis2BaseFeature
{
    ...
    private function _simulate(WebsiteAnalysisApis2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(WebsiteAnalysisApis2Context $ctx, array $applied): void
    {
        $client = $this->client;
