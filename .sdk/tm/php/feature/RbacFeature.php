...
// WebsiteAnalysisApis2 SDK rbac feature
...
class WebsiteAnalysisApis2RbacFeature extends WebsiteAnalysisApis2BaseFeature
{
    ...
    private function _required(WebsiteAnalysisApis2Context $ctx): ?string
    {
    ...
    private function _reject(WebsiteAnalysisApis2Context $ctx, string $required): void
    {
    ...
    private function _track(WebsiteAnalysisApis2Context $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
