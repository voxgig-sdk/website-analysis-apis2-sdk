...
from projectname_sdk.core.control import WebsiteAnalysisApis2Control
...
class WebsiteAnalysisApis2Context:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = WebsiteAnalysisApis2Control()
        ...
        if isinstance(sp, WebsiteAnalysisApis2Spec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, WebsiteAnalysisApis2Result):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, WebsiteAnalysisApis2Response):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return WebsiteAnalysisApis2Operation({})
        ...
        op = WebsiteAnalysisApis2Operation({
            "entity": entname,
            "name": opname,
            "input": inpt,
            "points": points,
    ...
    def make_error(self, code, msg):
        return WebsiteAnalysisApis2Error(code, msg, self)
