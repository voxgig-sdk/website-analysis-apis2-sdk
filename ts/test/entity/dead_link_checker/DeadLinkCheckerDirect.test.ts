...
describe('DeadLinkCheckerDirect', async () => {
  ...
  test('direct-list-dead_link_checker', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-dead_link_checker', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['WEBSITE_ANALYSIS_APIS2_TEST_DEAD_LINK_CHECKER_ENTID']
