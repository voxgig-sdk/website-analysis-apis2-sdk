...
describe('TechStackDetectionDirect', async () => {
  ...
  test('direct-list-tech_stack_detection', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-tech_stack_detection', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['WEBSITE_ANALYSIS_APIS2_TEST_TECH_STACK_DETECTION_ENTID']
