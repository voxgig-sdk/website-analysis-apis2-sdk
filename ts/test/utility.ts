...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.WEBSITEANALYSISAPIS2_TEST_LIVE ||
    'TRUE' === process.env.WEBSITEANALYSISAPIS2_TEST_OVERRIDE
  ) {
  ...
  m.WEBSITEANALYSISAPIS2_TEST_EXPLAIN = process.env.WEBSITEANALYSISAPIS2_TEST_EXPLAIN || m.WEBSITEANALYSISAPIS2_TEST_EXPLAIN
