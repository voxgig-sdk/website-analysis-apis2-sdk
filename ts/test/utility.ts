...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.WEBSITE_ANALYSIS_APIS2_TEST_LIVE ||
    'TRUE' === process.env.WEBSITE_ANALYSIS_APIS2_TEST_OVERRIDE
  ) {
  ...
  m.WEBSITE_ANALYSIS_APIS2_TEST_EXPLAIN = process.env.WEBSITE_ANALYSIS_APIS2_TEST_EXPLAIN || m.WEBSITE_ANALYSIS_APIS2_TEST_EXPLAIN
