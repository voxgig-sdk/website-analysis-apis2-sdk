...
local TechStackDetectionEntity = {}
TechStackDetectionEntity.__index = TechStackDetectionEntity


function TechStackDetectionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, TechStackDetectionEntity)
  self._name = "tech_stack_detection"
  self._client = client
...
function TechStackDetectionEntity:get_name()
  return self._name
end


function TechStackDetectionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return TechStackDetectionEntity.new(self._client, opts)
end
...
function TechStackDetectionEntity:mark_deleted()
  self._deleted = true
end


function TechStackDetectionEntity:deleted()
  return true == self._deleted
end


function TechStackDetectionEntity:data_set(args)
  if args ~= nil then
...
function TechStackDetectionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function TechStackDetectionEntity:match_set(args)
  if args ~= nil then
...
function TechStackDetectionEntity:match_get()
...
function TechStackDetectionEntity:stream(action, args, callopts)
...
---@param reqmatch TechStackDetectionListMatch
---@param ctrl? table
---@return TechStackDetection[]
---@return string? err
function TechStackDetectionEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function TechStackDetectionEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return TechStackDetectionEntity
