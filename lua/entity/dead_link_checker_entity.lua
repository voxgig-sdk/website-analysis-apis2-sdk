...
local DeadLinkCheckerEntity = {}
DeadLinkCheckerEntity.__index = DeadLinkCheckerEntity


function DeadLinkCheckerEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DeadLinkCheckerEntity)
  self._name = "dead_link_checker"
  self._client = client
...
function DeadLinkCheckerEntity:get_name()
  return self._name
end


function DeadLinkCheckerEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DeadLinkCheckerEntity.new(self._client, opts)
end
...
function DeadLinkCheckerEntity:mark_deleted()
  self._deleted = true
end


function DeadLinkCheckerEntity:deleted()
  return true == self._deleted
end


function DeadLinkCheckerEntity:data_set(args)
  if args ~= nil then
...
function DeadLinkCheckerEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DeadLinkCheckerEntity:match_set(args)
  if args ~= nil then
...
function DeadLinkCheckerEntity:match_get()
...
function DeadLinkCheckerEntity:stream(action, args, callopts)
...
---@param reqmatch DeadLinkCheckerListMatch
---@param ctrl? table
---@return DeadLinkChecker[]
---@return string? err
function DeadLinkCheckerEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function DeadLinkCheckerEntity:_run_op(ctx, post_done)
  local utility = self._utility
