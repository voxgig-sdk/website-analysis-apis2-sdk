...
local SDK_MODULE = "website-analysis-apis2_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["dead_link_checker"] = { ["test01"] = { id = "test01" } }, ["performance"] = { ["test01"] = { id = "test01" } }, ["screenshot"] = { ["test01"] = { id = "test01" } }, ["seo"] = { ["test01"] = { id = "test01" } }, ["ssl"] = { ["test01"] = { id = "test01" } }, ["tech_stack_detection"] = { ["test01"] = { id = "test01" } } } }'
