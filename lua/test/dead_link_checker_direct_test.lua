...
describe("DeadLinkCheckerDirect", function()
  it("should direct-list-dead_link_checker", function()
    local setup = dead_link_checker_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-dead_link_checker", setup.live and "live" or "unit")
