...
describe("ScreenshotDirect", function()
  it("should direct-load-screenshot", function()
    local setup = screenshot_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-screenshot", setup.live and "live" or "unit")
