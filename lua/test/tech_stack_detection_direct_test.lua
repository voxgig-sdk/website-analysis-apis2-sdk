...
describe("TechStackDetectionDirect", function()
  it("should direct-list-tech_stack_detection", function()
    local setup = tech_stack_detection_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-tech_stack_detection", setup.live and "live" or "unit")
