...
describe("PerformanceDirect", function()
  it("should direct-load-performance", function()
    local setup = performance_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-performance", setup.live and "live" or "unit")
