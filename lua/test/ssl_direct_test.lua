...
describe("SslDirect", function()
  it("should direct-load-ssl", function()
    local setup = ssl_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-ssl", setup.live and "live" or "unit")
