...
describe("SeoDirect", function()
  it("should direct-list-seo", function()
    local setup = seo_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-seo", setup.live and "live" or "unit")
