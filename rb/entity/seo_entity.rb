...
class SeoEntity
  ...
  # @return [Seo, Hash] the current Seo data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Seo fields)
  def match_get
  ...
  #
  # @param reqmatch [SeoListMatch, Hash, nil] match filter (any subset of
  #   Seo fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Seo>, Array] the matching Seo items; raises WebsiteAnalysisApis2Error on failure
