...
class SslEntity
  ...
  # Load a single Ssl.
  #
  # @param reqmatch [SslLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Ssl.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Ssl, Hash] the loaded Ssl; raises WebsiteAnalysisApis2Error on failure
