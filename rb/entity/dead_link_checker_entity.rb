...
class DeadLinkCheckerEntity
  ...
  def make
    opts = @_entopts.dup
    DeadLinkCheckerEntity.new(@_client, opts)
  end
  ...
  # @return [DeadLinkChecker, Hash] the current DeadLinkChecker data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of DeadLinkChecker fields)
  def match_get
  ...
  #
  # @param reqmatch [DeadLinkCheckerListMatch, Hash, nil] match filter (any subset of
  #   DeadLinkChecker fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<DeadLinkChecker>, Array] the matching DeadLinkChecker items; raises WebsiteAnalysisApis2Error on failure
