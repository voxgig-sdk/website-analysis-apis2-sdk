...
class SeoEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set WEBSITEANALYSISAPIS__TEST_SEO_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def seo_basic_setup(extra)
  ...
  entid_env_raw = ENV["WEBSITEANALYSISAPIS__TEST_SEO_ENTID"]
