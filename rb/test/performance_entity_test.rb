...
class PerformanceEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set WEBSITEANALYSISAPIS__TEST_PERFORMANCE_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def performance_basic_setup(extra)
  ...
  entid_env_raw = ENV["WEBSITEANALYSISAPIS__TEST_PERFORMANCE_ENTID"]
