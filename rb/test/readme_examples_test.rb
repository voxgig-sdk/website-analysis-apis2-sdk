...
#      offline in seeded test mode (WebsiteAnalysisApis2SDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "WebsiteAnalysisApis2_sdk.rb")
  SDK_CLASS = "WebsiteAnalysisApis2SDK"
  ...
  SDK_BASE = "WebsiteAnalysisApis2_sdk"
