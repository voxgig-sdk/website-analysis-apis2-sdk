// Command WebsiteAnalysisApis2-mcp is an MCP server exposing the WebsiteAnalysisApis2
// SDK as MCP tools.
//
// Two tools are registered:
//
//	WebsiteAnalysisApis2_list  — list records of an entity
//	WebsiteAnalysisApis2_load  — load a single record of an entity
//
